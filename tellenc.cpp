...
//
// I recommend building the Windows executable with MSVC 7.1 + STLport 5.1.0:
//
//  CL /Ox /GX /Gr /G7 /D_STLP_NO_IOSTREAMS tellenc.cpp /link /opt:nowin98
//
// This executable is smaller than what is generated by a more modern
// compiler (if the result also depends only on system DLLs).  Previously I
// could get an even smaller executable with MSVC 6 + STLport 4.5.1:
//
 ...
 *    frequency and are also unique (not already in #freq_analysis_data)
 * -# Add the value pair { \e code, \e encoding_name } to
 *    #freq_analysis_data
 *
